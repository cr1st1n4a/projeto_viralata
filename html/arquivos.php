/meu_projeto/
  /app/
    /controllers/
      AnimalController.php  Cristina        // Controlador para manipulação de dados de animais (CRUD)
    ...
    /views/
      ...
      index.html  Cristina                  // Página inicial que exibe a lista de animais
      criar.html  Cristina                    // Formulário para cadastrar um novo animal
